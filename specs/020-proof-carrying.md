...
- Versioned constants: SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`,
  ...
  `SciExact::to_f64`; `G`, `mu0`, `epsilon0`, `Z0`, `alpha`, `inv_alpha`, `Rinf`, `a0`, `Eh`, and `m_p` Qty values are the CODATA centres
  inside the hulls.
