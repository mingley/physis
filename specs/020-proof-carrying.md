...
- Versioned constants: SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`,
  ...
  `137.035999084(21)` from the same table. CODATA 2018 Rydberg `R∞` is a
  one-sigma `Interval` `10973731.568160(21)` m⁻¹ from the same table.
  CODATA 2018 Bohr radius `a₀` is a one-sigma `Interval`
  `5.29177210903(80)×10^{-11}` m from the same table; Hartree energy is
  not stored.
  ...
  `SciExact::to_f64`; `G`, `mu0`, `epsilon0`, `Z0`, `alpha`, `inv_alpha`, `Rinf`, `a0`, and `m_p` Qty values are the CODATA centres
  inside the hulls.
