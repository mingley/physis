...
- Versioned constants: SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`,
  ...
  (not an SI defining `Ratio`; not the energy hull; not the length hull; not a FormalClaim of the quotient from live lookups). IAU 2012 `au` is an exact
