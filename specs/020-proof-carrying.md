...
- Versioned constants: SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`,
  ...
  (not an SI defining `Ratio`; not the kg hull; not the joule energy equivalent; not the MeV/c companion; not a FormalClaim of the product from live lookups). IAU 2012 `au` is an exact
