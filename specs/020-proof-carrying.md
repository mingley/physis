...
- Versioned constants: SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`,
  ...
  decimal (`SciExact::to_f64`, not reduced `Ratio::to_f64`); `n0`/`Vm_atm`/`n0_atm`/`c2`/`KJ`/`RK`/`k_eV`/`k_Hz`/`k_m`/`h_eVHz`/`kg_J`/`m_eV`/`J_eV`/`J_K`/`eV_Hz`/`eV_K`/`Hz_K` via IEEE rounding of the exact `Ratio`; `h`/`c1L`/`m_J` via
