...
- Versioned constants: SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`,
  ...
  `137.035999084(21)` from the same table; Rydberg is not stored.
  ...
  `SciExact::to_f64`; `G`, `mu0`, `epsilon0`, `Z0`, `alpha`, `inv_alpha`, and `m_p` Qty values are the CODATA centres
  inside the hulls.
