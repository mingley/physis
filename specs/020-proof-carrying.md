...
- Versioned constants: SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`,
  ...
  (not an SI defining `Ratio`; not vacuum permittivity; not a FormalClaim of the printed quotient or 4pi epsilon0 from live lookups). IAU 2012 `au` is an exact
