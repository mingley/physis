...
- Versioned constants: SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`,
  ...
  `Z₀` is not stored. CODATA 2018 `α` is a
  ...
  `SciExact::to_f64`; `G`, `mu0`, `epsilon0`, `alpha`, and `m_p` Qty values are the CODATA centres
  inside the hulls.
