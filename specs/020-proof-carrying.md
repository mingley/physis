...
- Versioned constants: SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`,
  ...
  `c`, `au`, `p0`, `GM_sun`, `R_sun`, and `L_sun` via integer `to_f64`; `e`/`k`/`eV`/`NAh`/`NAk`/`NAe` via IEEE rounding of the SI
