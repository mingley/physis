...
- Versioned constants: SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`,
  ...
  (not an SI defining `Ratio`; Ratio scale `10^{41}` overflows `i128`; not `m_e_u`; not `m_e_c2`; not `M_e`; not a FormalClaim of `m_e_u × m_u`). IAU 2012 `au` is an exact
