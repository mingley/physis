...
- Versioned constants: SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`,
  ...
  (not an SI defining `Ratio`; not natural-unit momentum; not a FormalClaim of the printed quotient from live lookups). IAU 2012 `au` is an exact
