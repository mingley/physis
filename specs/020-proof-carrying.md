...
- Versioned constants: SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`,
  ...
  the same table; the energy equivalent `hcR∞` is not stored. CODATA 2018
  Rydberg `R∞` is a
  ...
  `SciExact::to_f64`; `G`, `mu0`, `epsilon0`, `Z0`, `alpha`, `inv_alpha`, `cRinf`, `Rinf`, `a0`, `Eh`, and `m_p` Qty values are the CODATA centres
  inside the hulls.
