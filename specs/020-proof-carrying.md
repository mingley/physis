...
- Versioned constants: SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`,
  ...
  `SciExact`: 3, 19, 389, and 12043 remain in the denominator; Boltzmann in Hz/K is not stored).
  ...
  decimal (`SciExact::to_f64`, not reduced `Ratio::to_f64`); `n0`/`Vm_atm`/`n0_atm`/`c2`/`KJ`/`RK`/`k_eV` via IEEE rounding of the exact `Ratio`; `h`/`c1L` via
