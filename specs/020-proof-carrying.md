...
- `physis why` / `physis epistemics` do not print a `theorem` tag.
  ...
  The overlay paths are `Verdict::with_certified_numeric`,
  `Verdict::with_interval_enclosure` (not P3N), and `Verdict::with_statistical_nll`.
...
- `sr.energy-momentum-invariant`: `(E−βp)² − (p−βE)² − (1−β²)(E²−p²) ≡ 0`
  ...
  rest-mass check `E² − (pc)² = (mc²)²` remains the evaluator. `sr.cross-product-jacobi` is the x-component of a×(b×c)+cyclic (`cross_product_jacobi`, `grind`); not the interval polynomial.
...
| roles | `Role`, `ResearchBudget`, `physis formalize` | Named processes propose; only `verify` mints. Explorer cannot prove or score. Proof-searcher cannot remint. Replication-agent remints (not P4). Empirical-analyst scores. Numerical-verifier encloses (`CertifiedNumeric` Ratio cells and an independent `Interval` parse of the GQW, one-loop α_3, and one-loop α_em⁻¹ input-interval overlays; those are not P3N). Provenance-auditor cites and independently rebuilds versioned constants (`physis constant`). Encoding-auditor round-trips live IR packages. Judge rebuilds `from_lab` (JSON cannot mint `logical proved`). Budget is a cap, not a proof |
...
| constants | `physis-constants`, `physis constant` | Versioned SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`, `K_cd` as exact `Ratio`. Planck `h` is SI-exact `SciExact` `662607015e-42` (not a `Ratio`: `i128` denominator overflow). CODATA 2018 Planck constant in eV/Hz `h_eVHz` is an exact `Ratio` `44173801/10681177560000000000000` eV Hz⁻¹ from JPCRD table XXXI UNIVERSAL (not a terminating `SciExact`: 2, 3, 5, 19, 389, and 12043 remain in the denominator; `ħ` is not stored). CODATA 2018 kilogram-joule relationship `kg_J` is an exact `Ratio` `89875517873681764` J from JPCRD table XXXV (not SI metre-per-second `c`; not second radiation `c2`; not a FormalClaim of `c*c` from live lookups). CODATA 2018 joule-kilogram relationship `J_kg` is an exact `Ratio` `1/89875517873681764` kg from JPCRD table XXXV (not a terminating `SciExact`: 7, 73, and 293339 remain in the denominator; not kilogram-joule inverted as a second name; not a FormalClaim of the SI quotient from live lookups). CODATA 2018 inverse meter-joule relationship `m_J` is SI-exact `SciExact` `19864458571489287e-41` J from JPCRD table XXXV (not a `Ratio`: `i128` denominator overflow; not `h`; not `c`; not `c1L`; not a FormalClaim of `h*c` from live lookups). CODATA 2018 inverse meter-electron volt relationship `m_eV` is an exact `Ratio` `6621486190496429/5340588780000000000000` eV from JPCRD table XXXV (not a terminating `SciExact`: 2, 3, 5, 19, 389, and 12043 remain in the denominator; not `h`; not `c`; not a FormalClaim of `h c / e` from live lookups). CODATA 2018 joule-electron volt relationship `J_eV` is an exact `Ratio` `5000000000000000000000000000/801088317` eV from JPCRD table XXXV (not a terminating `SciExact`: 3, 19, 389, and 12043 remain in the denominator; not BIPM electronvolt; not inverse-meter eV; not a FormalClaim of `1/e` from live lookups). CODATA 2018 joule-kelvin relationship `J_K` is an exact `Ratio` `100000000000000000000000000000/1380649` K from JPCRD table XXXV (not a terminating `SciExact`: 73 and 18913 remain in the denominator; not BIPM Boltzmann; not a FormalClaim of `1/k` from live lookups). CODATA 2018 electron volt-hertz relationship `eV_Hz` is an exact `Ratio` `10681177560000000000000/44173801` Hz from JPCRD table XXXV (not a terminating `SciExact`: 7 and 6310543 remain in the denominator; not Planck in eV per hertz; not a FormalClaim of `e/h` from live lookups). CODATA 2018 electron volt-kelvin relationship `eV_K` is an exact `Ratio` `16021766340/1380649` K from JPCRD table XXXV (not a terminating `SciExact`: 73 and 18913 remain in the denominator; not Boltzmann in eV per kelvin; not a FormalClaim of `e/k` from live lookups). CODATA 2018 hertz-kelvin relationship `Hz_K` is an exact `Ratio` `132521403/2761298000000000000` K from JPCRD table XXXV (not a terminating `SciExact`: 73 and 18913 remain in the denominator; not Boltzmann in hertz per kelvin; not a FormalClaim of `h/k` from live lookups). CODATA 2018 hertz-inverse meter relationship `Hz_m` is an exact `Ratio` `1/299792458` m⁻¹ from JPCRD table XXXV (not a terminating `SciExact`: 7, 73, and 293339 remain in the denominator; not SI metre-per-second; not a FormalClaim of `1/c` from live lookups). CODATA 2018 electron volt-inverse meter relationship `eV_m` is an exact `Ratio` `5340588780000000000000/6621486190496429` m⁻¹ from JPCRD table XXXV (not a terminating `SciExact`: 7, 73, 293339, and 6310543 remain in the denominator; not inverse-meter eV; not a FormalClaim of `e/(h c)` from live lookups). CODATA 2018 hertz-hartree relationship `Hz_Eh` is a one-sigma `Interval` `1.5198298460570(29)×10^{-16}` from JPCRD table XXXV (not an SI defining `Ratio`; not joule energy; not the eV companion; not a FormalClaim of the quotient from live lookups). CODATA 2018 hertz-atomic mass unit relationship `Hz_u` is a one-sigma `Interval` `4.4398216652(13)×10^{-24}` from JPCRD table XXXV (not an SI defining `Ratio`; not the kg atomic mass constant; not a FormalClaim of the quotient from live lookups). CODATA 2018 atomic mass unit-hertz relationship `u_Hz` is a one-sigma `Interval` `2.25234271871(68)×10^{23}` from JPCRD table XXXV (not an SI defining `Ratio`; not the hertz-atomic mass unit listing; not Rydberg frequency; not a FormalClaim of the quotient from live lookups). CODATA 2018 hartree-hertz relationship `Eh_Hz` is a one-sigma `Interval` `6.579683920502(13)×10^{15}` from JPCRD table XXXV (not an SI defining `Ratio`; not the hertz-hartree listing; not Rydberg frequency; not a FormalClaim of the quotient from live lookups). CODATA 2018 hartree-inverse meter relationship `Eh_m` is a one-sigma `Interval` `2.1947463136320(43)×10^{7}` from JPCRD table XXXV (not an SI defining `Ratio`; not Rydberg constant; not SI-exact hertz-inverse meter; not a FormalClaim of twice Rydberg from live lookups). CODATA 2018 inverse meter-hartree relationship `m_Eh` is a one-sigma `Interval` `4.5563352529120(88)×10^{-8}` from JPCRD table XXXV (not an SI defining `Ratio`; not the hartree-inverse meter listing; not Rydberg constant; not a FormalClaim of the quotient from live lookups). CODATA 2018 hartree-kelvin relationship `Eh_K` is a one-sigma `Interval` `3.1577502480407(61)×10^{5}` from JPCRD table XXXV (not an SI defining `Ratio`; not joule-kelvin; not electron volt-kelvin; not a FormalClaim of the quotient from live lookups). CODATA 2018 kelvin-hartree relationship `K_Eh` is a one-sigma `Interval` `3.1668115634556(61)×10^{-6}` from JPCRD table XXXV (not an SI defining `Ratio`; not the hartree-kelvin listing; not Boltzmann; not a FormalClaim of the quotient from live lookups). CODATA 2018 hartree-atomic mass unit relationship `Eh_u` is a one-sigma `Interval` `2.92126232205(88)×10^{-8}` from JPCRD table XXXV (not an SI defining `Ratio`; not the joule energy; not the eV companion; not a FormalClaim of the quotient from live lookups). CODATA 2018 electron volt-hartree relationship `eV_Eh` is a one-sigma `Interval` `3.6749322175655(71)×10^{-2}` from JPCRD table XXXV (not an SI defining `Ratio`; not the joule energy; not a FormalClaim of the quotient from live lookups). CODATA 2018 joule-hartree relationship `J_Eh` is a one-sigma `Interval` `2.2937122783963(45)×10^{17}` from JPCRD table XXXV (not an SI defining `Ratio`; not the hartree energy; not a FormalClaim of the quotient from live lookups). CODATA 2018 atomic mass unit-hartree relationship `u_Eh` is a one-sigma `Interval` `3.4231776874(10)×10^{7}` from JPCRD table XXXV (not an SI defining `Ratio`; not the hartree-atomic mass unit listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 kilogram-hartree relationship `kg_Eh` is a one-sigma `Interval` `2.0614857887409(40)×10^{34}` from JPCRD table XXXV (not an SI defining `Ratio`; not the hartree-kilogram listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 kilogram-atomic mass unit relationship `kg_u` is a one-sigma `Interval` `6.0221407621(18)×10^{26}` from JPCRD table XXXV (not an SI defining `Ratio`; not the kg atomic mass constant listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 joule-atomic mass unit relationship `J_u` is a one-sigma `Interval` `6.7005352565(20)×10^{9}` from JPCRD table XXXV (not an SI defining `Ratio`; not the atomic mass constant energy-equivalent listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 kelvin-atomic mass unit relationship `K_u` is a one-sigma `Interval` `9.2510873014(28)×10^{-14}` from JPCRD table XXXV (not an SI defining `Ratio`; not the kelvin-hartree listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 electron volt-atomic mass unit relationship `eV_u` is a one-sigma `Interval` `1.07354410233(32)×10^{-9}` from JPCRD table XXXV (not an SI defining `Ratio`; not the electron volt-hartree listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 atomic mass unit-electron volt relationship `u_eV` is a one-sigma `Interval` `9.3149410242(28)×10^{8}` from JPCRD table XXXV (not an SI defining `Ratio`; not the electron volt-atomic mass unit listing; not the MeV companion; not a FormalClaim of the quotient from live lookups). CODATA 2018 atomic mass unit-inverse meter relationship `u_m` is a one-sigma `Interval` `7.5130066104(23)×10^{14}` from JPCRD table XXXV (not an SI defining `Ratio`; not Rydberg constant; not the hartree-inverse meter listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 atomic mass unit-kelvin relationship `u_K` is a one-sigma `Interval` `1.08095401916(33)×10^{13}` from JPCRD table XXXV (not an SI defining `Ratio`; not kelvin-atomic mass unit inverted; not the hartree-kelvin listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 hartree-kilogram relationship `Eh_kg` is a one-sigma `SciInterval` `4.8508702095432(94)×10^{-35}` from JPCRD table XXXV (not an SI defining `Ratio`; not kilogram-hartree inverted; not the joule energy listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 lattice parameter of silicon `a_Si` is a one-sigma `Interval` `5.431020511(89)×10^{-10}` from JPCRD table XXXIII (not an SI defining `Ratio`; not the Bohr-radius listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 molar volume of silicon `Vm_Si` is a one-sigma `Interval` `1.205883199(60)×10^{-5}` from JPCRD table XXXIII (not an SI defining `Ratio`; not the ideal-gas molar-volume listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 Angstrom star `Astar` is a one-sigma `Interval` `1.00001495(90)×10^{-10}` from JPCRD table XXXIII (not an SI defining `Ratio`; not the Bohr-radius listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 copper x unit `xu_Cu` is a one-sigma `Interval` `1.00207697(28)×10^{-13}` from JPCRD table XXXIII (not an SI defining `Ratio`; not the Bohr-radius listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 molybdenum x unit `xu_Mo` is a one-sigma `Interval` `1.00209952(53)×10^{-13}` from JPCRD table XXXIII (not an SI defining `Ratio`; not the Bohr-radius listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 atomic unit of current `au_I` is a one-sigma `Interval` `6.623618237510(13)×10^{-3}` from JPCRD table XXXIV (not an SI defining `Ratio`; not the elementary-charge listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 atomic unit of charge density `au_rho` is a one-sigma `Interval` `1.08120238457(49)×10^{12}` from JPCRD table XXXIV (not an SI defining `Ratio`; not the elementary-charge listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 atomic unit of electric field `au_E` is a one-sigma `Interval` `5.14220674763(78)×10^{11}` from JPCRD table XXXIV (not an SI defining `Ratio`; not the elementary-charge listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 atomic unit of electric field gradient `au_EFG` is a one-sigma `Interval` `9.7173624292(29)×10^{21}` from JPCRD table XXXIV (not an SI defining `Ratio`; not the elementary-charge listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 atomic unit of electric dipole moment `ea0` is a one-sigma `SciInterval` `8.4783536255(13)×10^{-30}` from JPCRD table XXXIV (not an SI defining `Ratio`; not the elementary-charge listing; not a FormalClaim of the product from live lookups). CODATA 2018 atomic unit of electric quadrupole moment `ea02` is a one-sigma `SciInterval` `4.4865515246(14)×10^{-40}` from JPCRD table XXXIV (not an SI defining `Ratio`; not the elementary-charge listing; not a FormalClaim of the product from live lookups). CODATA 2018 atomic unit of electric polarizability `au_pol` is a one-sigma `SciInterval` `1.64877727436(50)×10^{-41}` from JPCRD table XXXIV (not an SI defining `Ratio`; not the elementary-charge listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 atomic unit of 1st hyperpolarizability `au_hyp` is a one-sigma `SciInterval` `3.2063613061(15)×10^{-53}` from JPCRD table XXXIV (not an SI defining `Ratio`; not the elementary-charge listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 atomic unit of 2nd hyperpolarizability `au_hyp2` is a one-sigma `SciInterval` `6.2353799905(38)×10^{-65}` from JPCRD table XXXIV (not an SI defining `Ratio`; not the elementary-charge listing; not a FormalClaim of the quotient from live lookups). CODATA 2018 atomic unit of magnetic dipole moment `au_mu` is a one-sigma `Interval` `1.85480201566(56)×10^{-23}` from JPCRD table XXXIV (not an SI defining `Ratio`; not the Bohr-magneton listing; not a FormalClaim of twice Bohr magneton from live lookups). CODATA 2018 atomic unit of magnetic flux density `au_B` is a one-sigma `Interval` `2.35051756758(71)×10^{5}` from JPCRD table XXXIV (not an SI defining `Ratio`; not the magnetic-dipole listing; not a FormalClaim of the printed quotient from live lookups). CODATA 2018 atomic unit of magnetizability `au_chi` is a one-sigma `SciInterval` `7.8910366008(48)×10^{-29}` from JPCRD table XXXIV (not an SI defining `Ratio`; not the magnetic-flux-density listing; not a FormalClaim of the printed quotient from live lookups). CODATA 2018 triton-proton mag. mom. ratio `mu_t_mup` is a one-sigma `Interval` `1.0666399191(21)` from JPCRD table XXXI (not an SI defining `Ratio`; not the triton g-factor listing; not a FormalClaim of the printed quotient from live lookups; not bound HT). CODATA 2018 shielding difference of d and p in HD `sigma_dp` is a one-sigma `Interval` `2.0200(20)×10^{-8}` from JPCRD table XXXI (not an SI defining `Ratio`; not the proton shielding-correction listing; not a FormalClaim of the printed quotient from live lookups). CODATA 2018 shielding difference of t and p in HT `sigma_tp` is a one-sigma `Interval` `2.4140(20)×10^{-8}` from JPCRD table XXXI (not an SI defining `Ratio`; not the HD shielding-difference listing; not a FormalClaim of the printed quotient from live lookups). CODATA 2018 helion shielding shift `sigma_h` is a one-sigma `Interval` `5.996743(10)×10^{-5}` from JPCRD table XXXI (not an SI defining `Ratio`; not the HT shielding-difference listing; not a FormalClaim of the printed quotient from live lookups). CODATA 2018 `G` is a one-sigma `Interval` (JPCRD table XXXI UNIVERSAL). CODATA 2018 Planck mass `mP` is a one-sigma `Interval` `2.176434(24)×10^{-8}` from JPCRD table XXXI UNIVERSAL (not an SI defining `Ratio`; not proton mass `m_p`; not a FormalClaim of the printed square-root from live lookups). CODATA 2018 Planck mass energy equivalent `mPc2` is a one-sigma `Interval` `1.220890(14)×10^{19}` from JPCRD table XXXI UNIVERSAL (not an SI defining `Ratio`; not the kg Planck-mass listing; not a FormalClaim of the printed energy-equivalent formula from live lookups). CODATA 2018 Planck temperature `TP` is a one-sigma `Interval` `1.416784(16)×10^{32}` from JPCRD table XXXI UNIVERSAL (not an SI defining `Ratio`; not the solar effective-temperature listing; not a FormalClaim of the printed temperature formula from live lookups). CODATA 2018 Planck length `lP` is a one-sigma `SciInterval` `1.616255(18)×10^{-35}` from JPCRD table XXXI UNIVERSAL (not an SI defining `Ratio`; not the Bohr-radius listing; not a FormalClaim of the printed length formula from live lookups; `10^{41}` overflows `i128`). CODATA 2018 Planck time `tP` is a one-sigma `SciInterval` `5.391247(60)×10^{-44}` from JPCRD table XXXI UNIVERSAL (not an SI defining `Ratio`; not the atomic-unit-of-time listing; not a FormalClaim of the printed time formula from live lookups; `10^{50}` overflows `i128`). CODATA 2018 `μ₀` is a one-sigma `Interval` `1.25663706212(19)×10^{-6}` N A⁻² (JPCRD table XXXI UNIVERSAL). CODATA 2018 `ε₀` is a one-sigma `Interval` `8.8541878128(13)×10^{-12}` F m⁻¹ (JPCRD table XXXI UNIVERSAL). CODATA 2018 `Z₀` is a one-sigma `Interval` `376.730313668(57)` ohm (JPCRD table XXXI UNIVERSAL); `Y₀` is not stored. CODATA 2018 `α` is a one-sigma `Interval` `7.2973525693(11)×10^{-3}` (JPCRD table XXXI ATOMIC AND NUCLEAR). CODATA 2018 inverse-α is a one-sigma `Interval` `137.035999084(21)` from the same table. CODATA 2018 Rydberg frequency `cR∞` is a one-sigma `Interval` `3.2898419602508(64)×10^{15}` Hz from the same table. CODATA 2018 Rydberg energy equivalent `hcR∞` is a one-sigma `Interval` `2.1798723611035(42)×10^{-18}` J from the same table; CODATA 2018 `hcRinf_eV` is a one-sigma `Interval` `13.605693122994(26)` eV from the same table (not an SI defining `Ratio`; not `hcRinf`; not `Eh_eV`; not a FormalClaim of `hcRinf/e`; quantum of circulation still cites `π ℏ / m_e`). CODATA 2018 Rydberg `R∞` is a one-sigma `Interval` `10973731.568160(21)` m⁻¹ from the same table. CODATA 2018 Bohr radius `a₀` is a one-sigma `Interval` `5.29177210903(80)×10^{-11}` m from the same table. CODATA 2018 Hartree energy `E_h` is a one-sigma `Interval` `4.3597447222071(85)×10^{-18}` J from the same table; CODATA 2018 `Eh_eV` is a one-sigma `Interval` `27.211386245988(53)` eV from the same table (not an SI defining `Ratio`; not `Eh`; not a FormalClaim of `Eh/e`). CODATA 2018 electron-muon mass ratio `m_e/m_μ` is a one-sigma `Interval` `4.83633169(11)×10^{-3}` (JPCRD table XXXI Electron, e-). CODATA 2018 electron-proton mass ratio `m_e/m_p` is a one-sigma `Interval` `5.44617021487(33)×10^{-4}` from the same section. CODATA 2018 electron-neutron mass ratio `m_e/m_n` is a one-sigma `Interval` `5.4386734424(26)×10^{-4}` from the same section. CODATA 2018 electron-deuteron mass ratio `m_e/m_d` is a one-sigma `Interval` `2.724437107462(96)×10^{-4}` from the same section. CODATA 2018 electron-triton mass ratio `m_e/m_t` is a one-sigma `Interval` `1.819200062251(90)×10^{-4}` from the same section. CODATA 2018 electron-helion mass ratio `m_e/m_h` is a one-sigma `Interval` `1.819543074573(79)×10^{-4}` from the same section. CODATA 2018 electron to alpha particle mass ratio `m_e/m_α` is a one-sigma `Interval` `1.370933554787(45)×10^{-4}` from the same section. CODATA 2018 electron charge to mass quotient `−e/m_e` is a one-sigma `Interval` `−1.75882001076(53)×10^{11}` C kg⁻¹ from the same section. CODATA 2018 electron mass in u `m_e_u` is a one-sigma `Interval` `5.48579909065(16)×10^{-4}` u from the same section (not an SI defining `Ratio`; not `M_e`; not relative atomic mass; not kg `m_e`). CODATA 2018 electron mass energy equivalent `m_e_c2` is a one-sigma `Interval` `8.1871057769(25)×10^{-14}` J from the same section (not an SI defining `Ratio`; not `m_e_u`; not kg `m_e`; not `m_mu_c2`; not SI-exact `eV`). CODATA 2018 electron mass energy equivalent in MeV `m_e_c2_MeV` is a one-sigma `Interval` `0.51099895000(15)` MeV from the same section (not an SI defining `Ratio`; not `m_e_c2`; not `m_mu_c2_MeV`; not SI-exact `eV`). CODATA 2018 electron mass `m_e` is a one-sigma `SciInterval` `9.1093837015(28)×10^{-31}` kg from the same section (not an SI defining `Ratio`; Ratio scale `10^{41}` overflows `i128`; not `m_e_u`; not `m_e_c2`; not `M_e`; not a FormalClaim of `m_e_u × m_u`). CODATA 2018 natural unit of momentum `nu_p` is a one-sigma `Interval` `2.73092453075(82)×10^{-22}` kg m s^{-1} from JPCRD table XXXIV Natural units (not an SI defining `Ratio`; not the kg hull; not the joule energy equivalent; not the MeV/c companion; not a FormalClaim of the product from live lookups). CODATA 2018 atomic unit of force `au_F` is a one-sigma `Interval` `8.2387234983(12)×10^{-8}` N from JPCRD table XXXIV Atomic units (not an SI defining `Ratio`; not the energy hull; not the length hull; not a FormalClaim of the quotient from live lookups). CODATA 2018 atomic unit of velocity `au_v` is a one-sigma `Interval` `2.18769126364(33)×10^{6}` m s^{-1} from JPCRD table XXXIV Atomic units (not an SI defining `Ratio`; not SI metre-per-second; not a FormalClaim of the product from live lookups). CODATA 2018 atomic unit of permittivity `au_eps` is a one-sigma `Interval` `1.11265005545(17)×10^{-10}` F m^{-1} from JPCRD table XXXIV Atomic units (not an SI defining `Ratio`; not vacuum permittivity; not a FormalClaim of the printed quotient or 4pi epsilon0 from live lookups). CODATA 2018 atomic unit of momentum `au_p` is a one-sigma `Interval` `1.99285191410(30)×10^{-24}` kg m s^{-1} from JPCRD table XXXIV Atomic units (not an SI defining `Ratio`; not natural-unit momentum; not a FormalClaim of the printed quotient from live lookups). CODATA 2018 atomic unit of time `au_t` is a one-sigma `Interval` `2.4188843265857(47)×10^{-17}` s from JPCRD table XXXIV Atomic units (not an SI defining `Ratio`; not natural-unit time; not a FormalClaim of the printed quotient from live lookups). CODATA 2018 natural unit of time `nu_t` is a one-sigma `Interval` `1.28808866819(39)×10^{-21}` s from JPCRD table XXXIV Natural units (not an SI defining `Ratio`; not Planck time; not atomic-unit time; not a FormalClaim of the printed quotient from live lookups). CODATA 2018 electron molar mass `M_e` is a one-sigma `Interval` `5.4857990888(17)×10^{-7}` kg mol⁻¹ from the same section. CODATA 2018 reduced Compton wavelength `ƛ_C` is a one-sigma `Interval` `3.8615926796(12)×10^{-13}` m from the same section. CODATA 2018 Compton wavelength `λ_C` is a one-sigma `Interval` `2.42631023867(73)×10^{-12}` m from the same section. CODATA 2018 classical electron radius `r_e` is a one-sigma `Interval` `2.8179403262(13)×10^{-15}` m from the same section. CODATA 2018 electron magnetic moment `μ_e` is a one-sigma `Interval` `−9.2847647043(28)×10^{-24}` J T⁻¹ from the same section. CODATA 2018 electron magnetic moment to Bohr magneton ratio `μ_e/μ_B` is a one-sigma `Interval` `−1.00115965218128(18)` from the same section. CODATA 2018 electron magnetic moment to nuclear magneton ratio `μ_e/μ_N` is a one-sigma `Interval` `−1838.28197188(11)` from the same section. CODATA 2018 electron magnetic-moment anomaly `ae` is a one-sigma `Interval` `1.15965218128(18)×10^{-3}` from the same section. CODATA 2018 electron g-factor `ge` is a one-sigma `Interval` `−2.00231930436256(35)` from the same section. CODATA 2018 electron-muon magnetic-moment ratio `mu_e_mmu` is a one-sigma `Interval` `206.7669883(46)` from the same section. CODATA 2018 electron-proton magnetic-moment ratio `mu_e_mup` is a one-sigma `Interval` `−658.21068789(20)` from the same section. CODATA 2018 electron to shielded-proton magnetic-moment ratio `mu_e_mu0p` is a one-sigma `Interval` `−658.2275971(72)` from the same section. CODATA 2018 electron-neutron magnetic-moment ratio `mu_e_mun` is a one-sigma `Interval` `960.92050(23)` from the same section. CODATA 2018 electron-deuteron magnetic-moment ratio `mu_e_mud` is a one-sigma `Interval` `−2143.9234915(56)` from the same section. CODATA 2018 electron to shielded-helion magnetic-moment ratio `mu_e_mu0h` is a one-sigma `Interval` `864.058257(10)` from the same section. CODATA 2018 muon mass `m_mu` is a one-sigma `Interval` `1.883531627(42)×10^{-28}` kg (JPCRD table XXXI Muon, mu-). CODATA 2018 muon mass in u `m_mu_u` is a one-sigma `Interval` `0.1134289259(25)` u from the same section. CODATA 2018 muon mass energy equivalent `m_mu_c2` is a one-sigma `Interval` `1.692833804(38)×10^{-11}` J from the same section. CODATA 2018 muon mass energy equivalent in MeV `m_mu_c2_MeV` is a one-sigma `Interval` `105.6583755(23)` MeV from the same section. CODATA 2018 muon-electron mass ratio `mmu_me` is a one-sigma `Interval` `206.7682830(46)` from the same section. The muon-tau mass ratio is a PDG reprint of `m_tau c^2` (JPCRD table XXXI footnote e) and is not stored. CODATA 2018 muon-proton mass ratio `mmu_mp` is a one-sigma `Interval` `0.1126095264(25)` from the same section. CODATA 2018 muon-neutron mass ratio `mmu_mn` is a one-sigma `Interval` `0.1124545170(25)` from the same section. CODATA 2018 muon molar mass `M_mu` is a one-sigma `Interval` `1.134289259(25)×10^{-4}` kg mol⁻¹ from the same section. The reduced muon Compton wavelength is ħ/m_μc and is not stored. CODATA 2018 muon Compton wavelength `lambda_C_mu` is a one-sigma `Interval` `1.173444110(26)×10^{-14}` m from the same section. CODATA 2018 muon magnetic moment `mu_mu` is a one-sigma `Interval` `−4.49044830(10)×10^{-26}` J T⁻¹ from the same section. CODATA 2018 muon magnetic moment to Bohr magneton ratio `mu_mu_muB` is a one-sigma `Interval` `−4.84197047(11)×10^{-3}` from the same section. CODATA 2018 muon magnetic moment to nuclear magneton ratio `mu_mu_muN` is a one-sigma `Interval` `−8.89059703(20)` from the same section. CODATA 2018 muon magnetic-moment anomaly `amu` is a one-sigma `Interval` `1.16592089(63)×10^{-3}` from the same section. CODATA 2018 muon g-factor `gmu` is a one-sigma `Interval` `−2.0023318418(13)` from the same section. CODATA 2018 muon-proton magnetic-moment ratio `mu_mu_mup` is a one-sigma `Interval` `−3.183345142(71)` from the same section. CODATA 2018 `m_p` is a one-sigma `Interval` `1.67262192369(51)×10^{-27}` kg (JPCRD table XXXI Proton, p). CODATA 2018 proton mass in u `m_p_u` is a one-sigma `Interval` `1.007276466621(53)` u from the same section. CODATA 2018 proton mass energy equivalent `m_p_c2` is a one-sigma `Interval` `1.50327761598(46)×10^{-10}` J from the same section. CODATA 2018 proton mass energy equivalent in MeV `m_p_c2_MeV` is a one-sigma `Interval` `938.27208816(29)` MeV from the same section. CODATA 2018 proton-electron mass ratio `mp_me` is a one-sigma `Interval` `1836.15267343(11)` from the same section. CODATA 2018 proton-muon mass ratio `mp_mmu` is a one-sigma `Interval` `8.88024337(20)` from the same section. The proton-tau mass ratio is a PDG reprint of `m_tau c^2` (JPCRD table XXXI footnote e) and is not stored. CODATA 2018 proton-neutron mass ratio `mp_mn` is a one-sigma `Interval` `0.99862347812(49)` from the same section. CODATA 2018 proton charge-to-mass quotient `e_mp` is a one-sigma `Interval` `9.5788331560(29)×10^{7}` C kg⁻¹ from the same section. CODATA 2018 proton molar mass `M_p` is a one-sigma `Interval` `1.00727646627(31)×10^{-3}` kg mol⁻¹ from the same section; CODATA 2018 proton Compton wavelength `lambda_C_p` is a one-sigma `Interval` `1.32140985539(40)×10^{-15}` m from the same section; CODATA 2018 proton rms charge radius `rp` is a one-sigma `Interval` `8.414(19)×10^{-16}` m from the same section; CODATA 2018 proton magnetic moment `mu_p` is a one-sigma `Interval` `1.41060679736(60)×10^{-26}` J T⁻¹ from the same section; CODATA 2018 proton magnetic moment to Bohr magneton ratio `mu_p_muB` is a one-sigma `Interval` `1.52103220230(46)×10^{-3}` from the same section; CODATA 2018 proton magnetic moment to nuclear magneton ratio `mu_p_muN` is a one-sigma `Interval` `2.79284734463(82)` from the same section; CODATA 2018 proton g-factor `gp` is a one-sigma `Interval` `5.5856946893(16)` from the same section; CODATA 2018 proton-neutron magnetic-moment ratio `mu_p_mun` is a one-sigma `Interval` `−1.45989805(34)` from the same section; CODATA 2018 shielded proton magnetic moment `mu0p` is a one-sigma `Interval` `1.410570560(15)×10^{-26}` J T⁻¹ from the same section; CODATA 2018 shielded proton magnetic moment to Bohr magneton ratio `mu0p_muB` is a one-sigma `Interval` `1.520993128(17)×10^{-3}` from the same section; CODATA 2018 shielded proton magnetic moment to nuclear magneton ratio `mu0p_muN` is a one-sigma `Interval` `2.792775599(30)` from the same section; CODATA 2018 proton magnetic shielding correction `sigma0p` is a one-sigma `Interval` `2.5689(11)×10^{-5}` from the same section; CODATA 2018 neutron mass `m_n` is a one-sigma `Interval` `1.67492749804(95)×10^{-27}` kg (JPCRD table XXXI Neutron, n); CODATA 2018 neutron mass in u `m_n_u` is a one-sigma `Interval` `1.00866491595(49)` u from the same section; CODATA 2018 neutron mass energy equivalent `m_n_c2` is a one-sigma `Interval` `1.50534976287(86)×10^{-10}` J from the same section; CODATA 2018 neutron mass energy equivalent in MeV `m_n_c2_MeV` is a one-sigma `Interval` `939.56542052(54)` MeV from the same section; CODATA 2018 neutron-electron mass ratio `mn_me` is a one-sigma `Interval` `1838.68366173(89)` from the same section; CODATA 2018 neutron-muon mass ratio `mn_mmu` is a one-sigma `Interval` `8.89248406(20)` from the same section; CODATA 2018 neutron-proton mass ratio `mn_mp` is a one-sigma `Interval` `1.00137841931(49)` from the same section; CODATA 2018 neutron-proton mass difference `mn_minus_mp` is a one-sigma `Interval` `2.30557435(82)×10^{-30}` kg from the same section; CODATA 2018 neutron-proton mass difference in u `mn_minus_mp_u` is a one-sigma `Interval` `1.38844933(49)×10^{-3}` u from the same section; CODATA 2018 neutron-proton mass difference energy equivalent `mn_minus_mp_c2` is a one-sigma `Interval` `2.07214689(74)×10^{-13}` J from the same section; CODATA 2018 neutron-proton mass difference energy equivalent in MeV `mn_minus_mp_c2_MeV` is a one-sigma `Interval` `1.29333236(46)` MeV from the same section; CODATA 2018 neutron molar mass `M_n` is a one-sigma `Interval` `1.00866491560(57)×10^{-3}` kg mol⁻¹ from the same section; CODATA 2018 neutron Compton wavelength `lambda_C_n` is a one-sigma `Interval` `1.31959090581(75)×10^{-15}` m from the same section; CODATA 2018 neutron magnetic moment `mu_n` is a one-sigma `Interval` `−9.6623651(23)×10^{-27}` J T⁻¹ from the same section; CODATA 2018 neutron magnetic moment to Bohr magneton ratio `mu_n_muB` is a one-sigma `Interval` `−1.04187563(25)×10^{-3}` from the same section; CODATA 2018 neutron magnetic moment to nuclear magneton ratio `mu_n_muN` is a one-sigma `Interval` `−1.91304273(45)` from the same section; CODATA 2018 neutron g-factor `gn` is a one-sigma `Interval` `−3.82608545(90)` from the same section; CODATA 2018 neutron-electron magnetic-moment ratio `mu_n_mue` is a one-sigma `Interval` `1.04066882(25)×10^{-3}` from the same section; CODATA 2018 neutron-proton magnetic-moment ratio `mu_n_mup` is a one-sigma `Interval` `−0.68497934(16)` from the same section; CODATA 2018 neutron to shielded-proton magnetic-moment ratio `mu_n_mu0p` is a one-sigma `Interval` `−0.68499694(16)` from the same section; CODATA 2018 deuteron mass `m_d` is a one-sigma `Interval` `3.3435837724(10)×10^{-27}` kg (JPCRD table XXXI Deuteron, d); CODATA 2018 deuteron mass in u `m_d_u` is a one-sigma `Interval` `2.013553212745(40)` u from the same section; CODATA 2018 deuteron mass energy equivalent `m_d_c2` is a one-sigma `Interval` `3.00506323102(91)×10^{-10}` J from the same section; CODATA 2018 deuteron mass energy equivalent in MeV `m_d_c2_MeV` is a one-sigma `Interval` `1875.61294257(57)` MeV from the same section; CODATA 2018 deuteron-electron mass ratio `md_me` is a one-sigma `Interval` `3670.48296788(13)` from the same section; CODATA 2018 deuteron-proton mass ratio `md_mp` is a one-sigma `Interval` `1.99900750139(11)` from the same section; CODATA 2018 deuteron molar mass `M_d` is a one-sigma `Interval` `2.01355321205(61)×10^{-3}` kg mol⁻¹ from the same section; CODATA 2018 deuteron rms charge radius `rd` is a one-sigma `Interval` `2.12799(74)×10^{-15}` m from the same section; CODATA 2018 deuteron magnetic moment `mu_d` is a one-sigma `Interval` `4.330735094(11)×10^{-27}` J T⁻¹ from the same section; CODATA 2018 deuteron magnetic moment to Bohr magneton ratio `mu_d_muB` is a one-sigma `Interval` `4.669754570(12)×10^{-4}` from the same section; CODATA 2018 deuteron magnetic moment to nuclear magneton ratio `mu_d_muN` is a one-sigma `Interval` `0.8574382338(22)` from the same section; CODATA 2018 deuteron g-factor `gd` is a one-sigma `Interval` `0.8574382338(22)` from the same section; CODATA 2018 deuteron-electron magnetic-moment ratio `mu_d_mue` is a one-sigma `Interval` `−4.664345551(12)×10^{-4}` from the same section; CODATA 2018 deuteron-proton magnetic-moment ratio `mu_d_mup` is a one-sigma `Interval` `0.30701220939(79)` from the same section; CODATA 2018 deuteron-neutron magnetic-moment ratio `mu_d_mun` is a one-sigma `Interval` `−0.44820653(11)` from the same section; CODATA 2018 triton mass `m_t` is a one-sigma `Interval` `5.0073567446(15)×10^{-27}` kg from JPCRD table XXXI Triton, t; CODATA 2018 triton mass in u `m_t_u` is a one-sigma `Interval` `3.01550071621(12)` u from the same section; CODATA 2018 triton mass energy equivalent `m_t_c2` is a one-sigma `Interval` `4.5003878060(14)×10^{-10}` J from the same section; CODATA 2018 triton mass energy equivalent in MeV `m_t_c2_MeV` is a one-sigma `Interval` `2808.92113298(85)` MeV from the same section; CODATA 2018 triton-electron mass ratio `mt_me` is a one-sigma `Interval` `5496.92153573(27)` from the same section; CODATA 2018 triton-proton mass ratio `mt_mp` is a one-sigma `Interval` `2.99371703414(15)` from the same section; CODATA 2018 triton molar mass `M_t` is a one-sigma `Interval` `3.01550071517(92)×10^{-3}` kg mol⁻¹ from the same section; CODATA 2018 triton magnetic moment `mu_t` is a one-sigma `Interval` `1.5046095202(30)×10^{-26}` J T⁻¹ from the same section; CODATA 2018 triton magnetic moment to Bohr magneton ratio `mu_t_muB` is a one-sigma `Interval` `1.6223936651(32)×10^{-3}` from the same section; CODATA 2018 triton magnetic moment to nuclear magneton ratio `mu_t_muN` is a one-sigma `Interval` `2.9789624656(59)` from the same section; CODATA 2018 triton g-factor `gt` is a one-sigma `Interval` `5.957924931(12)` from the same section; CODATA 2018 helion mass `m_h` is a one-sigma `Interval` `5.0064127796(15)×10^{-27}` kg from JPCRD table XXXI Helion, h; CODATA 2018 helion mass in u `m_h_u` is a one-sigma `Interval` `3.014932247175(97)` u from the same section; CODATA 2018 helion mass energy equivalent `m_h_c2` is a one-sigma `Interval` `4.4995394125(14)×10^{-10}` J from the same section; CODATA 2018 helion mass energy equivalent in MeV `m_h_c2_MeV` is a one-sigma `Interval` `2808.39160743(85)` MeV from the same section; CODATA 2018 helion-electron mass ratio `mh_me` is a one-sigma `Interval` `5495.88528007(24)` from the same section; CODATA 2018 helion-proton mass ratio `mh_mp` is a one-sigma `Interval` `2.99315267167(13)` from the same section; CODATA 2018 helion molar mass `M_h` is a one-sigma `Interval` `3.01493224613(91)×10^{-3}` kg mol⁻¹ from the same section; CODATA 2018 helion magnetic moment `mu_h` is a one-sigma `Interval` `−1.074617532(13)×10^{-26}` J T⁻¹ from the same section. CODATA 2018 helion magnetic moment to Bohr magneton ratio `mu_h_muB` is a one-sigma `Interval` `−1.158740958(14)×10^{-3}` from the same section. CODATA 2018 helion magnetic moment to nuclear magneton ratio `mu_h_muN` is a one-sigma `Interval` `−2.127625307(25)` from the same section. CODATA 2018 helion g-factor `gh` is a one-sigma `Interval` `−4.255250615(50)` from the same section. CODATA 2018 shielded helion magnetic moment `mu0h` is a one-sigma `Interval` `−1.074553090(13)×10^{-26}` J T⁻¹ from the same section; CODATA 2018 shielded helion mag. mom. to Bohr magneton ratio `mu0h_muB` is a one-sigma `Interval` `−1.158671471(14)×10^{-3}` from the same section; CODATA 2018 shielded helion mag. mom. to nuclear magneton ratio `mu0h_muN` is a one-sigma `Interval` `−2.127497719(25)` from the same section; CODATA 2018 shielded helion to proton mag. mom. ratio `mu0h_mup` is a one-sigma `Interval` `−0.7617665618(89)` from the same section; CODATA 2018 shielded helion to shielded proton mag. mom. ratio `mu0h_mu0p` is a one-sigma `Interval` `−0.7617861313(33)` from the same section; CODATA 2018 alpha particle mass `m_alpha` is a one-sigma `Interval` `6.6446573357(20)×10^{-27}` kg from JPCRD table XXXI Alpha particle, a; CODATA 2018 alpha particle mass in u `m_alpha_u` is a one-sigma `Interval` `4.001506179127(63)` u from the same section; CODATA 2018 alpha particle mass energy equivalent `m_alpha_c2` is a one-sigma `Interval` `5.9719201914(18)×10^{-10}` J from the same section; CODATA 2018 alpha particle mass energy equivalent in MeV `m_alpha_c2_MeV` is a one-sigma `Interval` `3727.3794066(11)` MeV from the same section; CODATA 2018 alpha particle-electron mass ratio `malpha_me` is a one-sigma `Interval` `7294.29954142(24)` from the same section; CODATA 2018 alpha particle-proton mass ratio `malpha_mp` is a one-sigma `Interval` `3.97259969009(22)` from the same section; CODATA 2018 alpha particle molar mass `M_alpha` is a one-sigma `Interval` `4.0015061777(12)×10^{-3}` kg mol⁻¹ from the same section; CODATA 2018 atomic mass constant `m_u` is a one-sigma `Interval` `1.66053906660(50)×10^{-27}` kg from JPCRD table XXXI PHYSICOCHEMICAL; CODATA 2018 atomic mass constant energy equivalent `m_u_c2` is a one-sigma `Interval` `1.49241808560(45)×10^{-10}` J from the same section; CODATA 2018 atomic mass constant energy equivalent in MeV `m_u_c2_MeV` is a one-sigma `Interval` `931.49410242(28)` MeV from the same section; CODATA 2018 molar mass constant `M_u` is a one-sigma `Interval` `0.99999999965(30)×10^{-3}` kg mol⁻¹ from the same section; CODATA 2018 molar mass of carbon-12 `M_12C` is a one-sigma `Interval` `11.9999999958(36)×10^{-3}` kg mol⁻¹ from the same section; CODATA 2018 molar Planck constant `NAh` is an exact `Ratio` `3.99031271289343140×10^{-10}` J Hz⁻¹ mol⁻¹ from the same section; CODATA 2018 molar gas constant `NAk` is an exact `Ratio` `8.31446261815324` J mol⁻¹ K⁻¹ from the same section; CODATA 2018 Boltzmann constant in eV/K `k_eV` is an exact `Ratio` `1380649/16021766340` eV K⁻¹ from the same section (not a terminating `SciExact`: 3, 19, 389, and 12043 remain in the denominator); CODATA 2018 Boltzmann constant in Hz/K `k_Hz` is an exact `Ratio` `2761298000000000000/132521403` Hz K⁻¹ from the same section (not a terminating `SciExact`: 3, 7, and 6310543 remain in the denominator); CODATA 2018 Boltzmann constant in inverse meter per kelvin `k_m` is an exact `Ratio` `18913000000000000/272115870842319` m⁻¹ K⁻¹ from the same section (not a terminating `SciExact`: 3, 7, 293339, and 6310543 remain in the denominator; Faraday constant is NAe); CODATA 2018 Faraday constant `NAe` is an exact `Ratio` `96485.3321233100184` C mol⁻¹ from the same section; CODATA 2018 standard-state pressure `p0` is an exact `Ratio` `100000` Pa from the same section; CODATA 2018 standard atmosphere `atm` is an exact `Ratio` `101325` Pa from the same section; CODATA 2018 molar volume of ideal gas `Vm` is an exact `Ratio` `0.022710954641485575` m³ mol⁻¹ from the same section at 273.15 K and 100 kPa; CODATA 2018 Loschmidt constant `n0` is an exact `Ratio` `200000000000000000000000000000000000/7542485487` m⁻³ from the same section at 273.15 K and 100 kPa; CODATA 2018 molar volume of ideal gas at 101.325 kPa `Vm_atm` is an exact `Ratio` `378515910691426251/16887500000000000000` m³ mol⁻¹ from the same section at 273.15 K; CODATA 2018 Loschmidt constant at 101.325 kPa `n0_atm` is an exact `Ratio` `67550000000000000000000000000000000/2514161829` m⁻³ from the same section at 273.15 K; CODATA 2018 Sackur-Tetrode constant `S0_R` is a one-sigma `Interval` `-1.15170753706(45)` from the same section at T1 = 1 K and p0 = 100 kPa; CODATA 2018 Sackur-Tetrode constant at 101.325 kPa `S0_R_atm` is a one-sigma `Interval` `-1.16487052358(45)` from the same section at T1 = 1 K; CODATA 2018 first radiation constant for spectral radiance `c1L` is SI-exact `SciExact` `11910429723971884140794892e-41` (not a `Ratio`: `i128` denominator overflow; Stefan-Boltzmann cites π and is not stored); CODATA 2018 second radiation constant `c2` is an exact `Ratio` `272115870842319/18913000000000000` m K from the same section (not a terminating `SciExact`: 18913 remains in the denominator; first radiation constant `c1` cites π and is not stored); CODATA 2018 Josephson constant `KJ` is an exact `Ratio` `21362355120000000000000/44173801` Hz V⁻¹ from JPCRD table XXXI ELECTROMAGNETIC (not a terminating `SciExact`: 7 and 6310543 remain in the denominator; magnetic flux quantum `Phi0` and conductance quantum `G0` cite π and ħ and are not stored); CODATA 2018 von Klitzing constant `RK` is an exact `Ratio` `5521725125000000000000/213914163877964163` ohm from the same section (not a terminating `SciExact`: 3, 19, 389, and 12043 remain in the denominator; JPCRD also writes `2πℏ/e²` and that printed formula is not stored); CODATA 2018 Bohr magneton `muB` is a one-sigma `Interval` `9.2740100783(28)×10^{-24}` J T⁻¹ from the same section (not an SI defining `Ratio`; not electron magnetic moment `mu_e`; not a FormalClaim of `eℏ/2me`); CODATA 2018 Bohr magneton in eV/T `muB_eV` is a one-sigma `Interval` `5.7883818060(17)×10^{-5}` eV T⁻¹ from the same section (not an SI defining `Ratio`; not `muB`; not a FormalClaim of `muB/e`); CODATA 2018 Bohr magneton in Hz/T `muB_Hz` is a one-sigma `Interval` `1.39962449361(42)×10^{10}` Hz T⁻¹ from the same section (not an SI defining `Ratio`; not `muB`; not a FormalClaim of `muB/h`); CODATA 2018 Bohr magneton in inverse meter per tesla `muB_m` is a one-sigma `Interval` `46.686447783(14)` m⁻¹ T⁻¹ from the same section (not an SI defining `Ratio`; not `muB`; not a FormalClaim of `muB/hc`); CODATA 2018 Bohr magneton in K/T `muB_K` is a one-sigma `Interval` `0.67171381563(20)` K T⁻¹ from the same section (not an SI defining `Ratio`; not `muB`; not a FormalClaim of `muB/k`); CODATA 2018 nuclear magneton `muN` is a one-sigma `Interval` `5.0507837461(15)×10^{-27}` J T⁻¹ from the same section (not an SI defining `Ratio`; not `muB`; not neutron magnetic moment `mu_n`; not a FormalClaim of `eℏ/2mp`); CODATA 2018 nuclear magneton in eV/T `muN_eV` is a one-sigma `Interval` `3.15245125844(96)×10^{-8}` eV T⁻¹ from the same section (not an SI defining `Ratio`; not `muN`; not `muB_eV`; not a FormalClaim of `muN/e`); CODATA 2018 nuclear magneton in inverse meter per tesla `muN_m` is a one-sigma `Interval` `2.54262341353(78)×10^{-2}` m⁻¹ T⁻¹ from the same section (not an SI defining `Ratio`; not `muN`; not `muB_m`; not a FormalClaim of `muN/hc`); CODATA 2018 nuclear magneton in K/T `muN_K` is a one-sigma `Interval` `3.6582677756(11)×10^{-4}` K T⁻¹ from the same section (not an SI defining `Ratio`; not `muN`; not `muB_K`; not a FormalClaim of `muN/k`); CODATA 2018 nuclear magneton in MHz/T `muN_MHz` is a one-sigma `Interval` `7.6225932291(23)` MHz T⁻¹ from the same section (not an SI defining `Ratio`; not `muN`; not `muB_Hz`; not a FormalClaim of `muN/h`); CODATA 2018 proton gyromagnetic ratio `gamma_p` is a one-sigma `Interval` `2.6752218744(11)×10^{8}` s⁻¹ T⁻¹ from JPCRD table XXXI Proton, p (not an SI defining `Ratio`; not `gp`; not `mu_p`; not `muN`; not `muB_Hz`; not `muN_MHz`; not a FormalClaim of `2 mu_p / hbar`); CODATA 2018 proton gyromagnetic ratio in MHz/T `gamma_p_MHz` is a one-sigma `Interval` `42.577478518(18)` MHz T⁻¹ from the same section (not an SI defining `Ratio`; not `gamma_p`; not `muN_MHz`; not `muB_Hz`; not a FormalClaim of `gamma_p / 2π`); CODATA 2018 shielded proton gyromagnetic ratio `gamma0p` is a one-sigma `Interval` `2.675153151(29)×10^{8}` s⁻¹ T⁻¹ from the same section (not an SI defining `Ratio`; not `gamma_p`; not `mu0p`; not `g0p`; not a FormalClaim of `2 mu0p / hbar`); CODATA 2018 shielded proton gyromagnetic ratio in MHz/T `gamma0p_MHz` is a one-sigma `Interval` `42.57638474(46)` MHz T⁻¹ from the same section (not an SI defining `Ratio`; not `gamma0p`; not `gamma_p_MHz`; not `muN_MHz`; not a FormalClaim of `gamma0p / 2π`); CODATA 2018 neutron gyromagnetic ratio `gamma_n` is a one-sigma `Interval` `1.83247171(43)×10^{8}` s⁻¹ T⁻¹ from JPCRD table XXXI Neutron, n (not an SI defining `Ratio`; not `gn`; not `gamma_p`; not `gamma0p`; not `mu_n`; not a FormalClaim of `2 mu_n / hbar`); CODATA 2018 neutron gyromagnetic ratio in MHz/T `gamma_n_MHz` is a one-sigma `Interval` `29.1646931(69)` MHz T⁻¹ from the same section (not an SI defining `Ratio`; not `gamma_n`; not `gamma_p_MHz`; not `gamma0p_MHz`; not `muN_MHz`; not a FormalClaim of `gamma_n / 2π`); CODATA 2018 electron gyromagnetic ratio `gamma_e` is a one-sigma `Interval` `1.76085963023(53)×10^{11}` s⁻¹ T⁻¹ from JPCRD table XXXI Electron, e- (not an SI defining `Ratio`; not `ge`; not `mu_e`; not `gamma_p`; not `gamma_n`; not a FormalClaim of `2 mu_e / hbar`); CODATA 2018 electron gyromagnetic ratio in MHz/T `gamma_e_MHz` is a one-sigma `Interval` `28024.9514242(85)` MHz T⁻¹ from the same section (not an SI defining `Ratio`; not `gamma_e`; not `gamma_p_MHz`; not `gamma_n_MHz`; not `gamma0p_MHz`; not a FormalClaim of `gamma_e / 2π`); CODATA 2018 shielded helion gyromagnetic ratio `gamma0h` is a one-sigma `Interval` `2.037894569(24)×10^{8}` s⁻¹ T⁻¹ from JPCRD table XXXI Helion, h (not an SI defining `Ratio`; not `gamma0p`; not `gamma_e`; not `mu0h`; not `gh`; not a FormalClaim of `2 mu0h / hbar`); CODATA 2018 shielded helion gyromagnetic ratio in MHz/T `gamma0h_MHz` is a one-sigma `Interval` `32.43409942(38)` MHz T⁻¹ from the same section (not an SI defining `Ratio`; not `gamma0h`; not `gamma0p_MHz`; not `gamma_e_MHz`; not `gamma_n_MHz`; not a FormalClaim of `gamma0h / 2π`; glossary `g0p` is still skipped). IAU 2012 `au` is an exact `Ratio` `149597870700` m (BIPM table 8). The electronvolt is an exact `Ratio` `1.602176634×10^{-19}` J from the same table (SI 2019, same decimal as `e`, unit joule). BIPM table 8 `barn` is an exact `Ratio` `1/10^{28}` square metres from the same table (not Thomson, not `Astar`). BIPM table 8 `angstrom` is an exact `Ratio` `1/10^{10}` m from the same table (not Angstrom star `Astar`). BIPM table 8 `gal` is an exact `Ratio` `1/100` m s^{-2} from the same table (not the CGPM 1901 standard gravity listing). BIPM table 8 `nautical_mile` is an exact `Ratio` `1852` m from the same table (not the astronomical-unit listing). BIPM table 8 `hectare` is an exact `Ratio` `10000` square metres from the same table (not the nuclear-physics area listing). BIPM table 8 `knot` is an exact `Ratio` `463/900` m s^{-1} from the same table (not the atomic-unit-of-velocity listing). BIPM table 8 `are` is an exact `Ratio` `100` square metres from the same table (not the 10^4 land-area listing). The parsec is `(648000/π) au` and is not a Ratio. IAU 2015 `(GM)_☉^N` is an exact `Ratio` `1.3271244×10^20` m³ s⁻² (AJ 152, 41 table 1): a conversion ruler, not a measured solar mass. IAU 2015 `R_☉^N` is an exact `Ratio` `695700000` m from the same table: a conversion ruler, not a measured photospheric radius. IAU 2015 `L_☉^N` is an exact `Ratio` `3.828×10^26` W from the same table: a conversion ruler, not a measured solar luminosity. IAU 2015 `S_☉^N` is an exact `Ratio` `1361` W m^{-2} from the same table: a conversion ruler, not a measured solar irradiance. IAU 2015 `T_☉^N` is an exact `Ratio` `5772` K from the same table: a conversion ruler, not a measured solar effective temperature. IAU 2015 `R_Ee^N` is an exact `Ratio` `6378100` m from the same table: a conversion ruler, not a measured terrestrial equatorial radius. IAU 2015 `R_Ep^N` is an exact `Ratio` `6356800` m from the same table: a conversion ruler, not a measured terrestrial polar radius. IAU 2015 `R_Je^N` is an exact `Ratio` `71492000` m from the same table: a conversion ruler, not a measured Jovian equatorial radius. IAU 2015 `R_Jp^N` is an exact `Ratio` `66854000` m from the same table: a conversion ruler, not a measured Jovian polar radius. IAU 2015 `(GM)_E^N` is an exact `Ratio` `3.986004×10^14` m³ s⁻² from the same table: a conversion ruler, not a measured terrestrial mass. IAU 2015 `(GM)_J^N` is an exact `Ratio` `1.2668653×10^17` m³ s⁻² from the same table: a conversion ruler, not a measured Jovian mass. IAU 2015 bolometric-magnitude zero is an exact `Ratio` `3.0128×10^28` W from Resolution B2 equation 1: a conversion ruler, not a measured luminosity. CGPM 1901 standard gravity is an exact `Ratio` `9.80665` m s^{-2} from Brochure page 154: a conversion ruler, not a measured local g. `physis constant [name]` independently rebuilds those hashes (`provenance-auditor`; not P3N). Omitted name rebuilds the full LEDGER into one VersionedConstant bundle. Overlapping `physis_model` Qty floats lockstep the ledger: `c`, `au`, `p0`, `atm`, `GM_sun`, `R_sun`, `L_sun`, `S_sun`, `T_sun`, `R_earth`, `R_earth_p`, `R_jup`, `R_jup_p`, `GM_earth`, `GM_jup`, and `L_0` via integer `to_f64`; `g0` via `Ratio` `to_f64`; `e`/`k`/`eV`/`NAh`/`NAk`/`NAe`/`Vm` via IEEE rounding of the SI decimal (`SciExact::to_f64`, not reduced `Ratio::to_f64`); `n0`/`Vm_atm`/`n0_atm`/`c2`/`KJ`/`RK`/`k_eV`/`k_Hz`/`k_m`/`h_eVHz`/`kg_J`/`J_kg`/`m_eV`/`J_eV`/`J_K`/`eV_Hz`/`eV_K`/`Hz_K`/`Hz_m`/`eV_m` via IEEE rounding of the exact `Ratio`; `h`/`c1L`/`m_J` via `SciExact::to_f64`; `G`, `mP`, `mPc2`, `TP`, `lP`, `tP`, `mu0`, `epsilon0`, `Z0`, `alpha`, `inv_alpha`, `cRinf`, `hcRinf`, `hcRinf_eV`, `Rinf`, `a0`, `Eh`, `Eh_eV`, `me_mmu`, `me_mp`, `me_mn`, `me_md`, `me_mt`, `me_mh`, `me_malpha`, `e_me`, `m_e`, `nu_p`, `au_F`, `au_v`, `au_eps`, `au_p`, `au_t`, `nu_t`, `m_e_u`, `m_e_c2`, `m_e_c2_MeV`, `M_e`, `lambdabar_C`, `lambda_C`, `re`, `mu_e`, `mu_e_muB`, `mu_e_muN`, `ae`, `ge`, `mu_e_mmu`, `mu_e_mup`, `mu_e_mu0p`, `mu_e_mun`, `mu_e_mud`, `mu_e_mu0h`, `m_mu`, `m_mu_u`, `m_mu_c2`, `m_mu_c2_MeV`, `mmu_me`, `mmu_mp`, `mmu_mn`, `M_mu`, `lambda_C_mu`, `mu_mu`, `mu_mu_muB`, `mu_mu_muN`, `amu`, `gmu`, `mu_mu_mup`, `m_p`, `m_p_u`, `m_p_c2`, `m_p_c2_MeV`, `mp_me`, `mp_mmu`, `mp_mn`, `e_mp`, `M_p`, `lambda_C_p`, `rp`, `mu_p`, `mu_p_muB`, `mu_p_muN`, `gp`, `mu_p_mun`, `mu0p`, `mu0p_muB`, `mu0p_muN`, `sigma0p`, `m_n`, `m_n_u`, `m_n_c2`, `m_n_c2_MeV`, `mn_me`, `mn_mmu`, `mn_mp`, `mn_minus_mp`, `mn_minus_mp_u`, `mn_minus_mp_c2`, `mn_minus_mp_c2_MeV`, `M_n`, `lambda_C_n`, `mu_n`, `mu_n_muB`, `mu_n_muN`, `gn`, `mu_n_mue`, `mu_n_mup`, `mu_n_mu0p`, `m_d`, `m_d_u`, `m_d_c2`, `m_d_c2_MeV`, `md_me`, `md_mp`, `M_d`, `rd`, `mu_d`, `mu_d_muB`, `mu_d_muN`, `gd`, `mu_d_mue`, `mu_d_mup`, `mu_d_mun`, `m_t`, `m_t_u`, `m_t_c2`, `m_t_c2_MeV`, `mt_me`, `mt_mp`, `M_t`, `mu_t`, `mu_t_muB`, `mu_t_muN`, `gt`, `m_h`, `m_h_u`, `m_h_c2`, `m_h_c2_MeV`, `mh_me`, `mh_mp`, `M_h`, `mu_h`, `mu_h_muB`, `mu_h_muN`, `gh`, `mu0h`, `mu0h_muB`, `mu0h_muN`, `mu0h_mup`, `mu0h_mu0p`, `m_alpha`, `m_alpha_u`, `m_alpha_c2`, `m_alpha_c2_MeV`, `malpha_me`, `malpha_mp`, `M_alpha`, `m_u`, `m_u_c2`, `m_u_c2_MeV`, `M_u`, `M_12C`, `S0_R`, `S0_R_atm`, `muB`, `muB_eV`, `muB_Hz`, `muB_m`, `muB_K`, `muN`, `muN_eV`, `muN_m`, `muN_K`, `muN_MHz`, `gamma_p`, `gamma_p_MHz`, `gamma0p`, `gamma0p_MHz`, `gamma_n`, `gamma_n_MHz`, `gamma_e`, `gamma_e_MHz`, `gamma0h`, `gamma0h_MHz`, and `Hz_Eh`, and `Hz_u`, and `u_Hz`, and `Eh_Hz`, and `Eh_m`, and `m_Eh`, and `Eh_K`, and `K_Eh`, and `Eh_u`, and `eV_Eh`, and `J_Eh`, and `u_Eh`, and `kg_Eh`, and `kg_u`, and `J_u`, and `K_u`, and `eV_u`, and `u_eV`, and `u_m`, and `u_K`, and `Eh_kg`, and `a_Si`, and `Vm_Si`, and `Astar`, and `xu_Cu`, and `xu_Mo`, and `au_I`, and `au_rho`, and `au_E`, and `au_EFG`, and `ea0`, and `ea02`, and `au_pol`, and `au_hyp`, and `au_hyp2`, and `au_mu`, and `au_B`, and `au_chi`, and `mu_t_mup`, and `sigma_dp`, and `sigma_tp`, and `sigma_h` Qty values are the CODATA centres inside the hulls. Theories still evaluate with `f64` Qty |
...
- Versioned constants: SI 2019 defining `c`, `Δν_Cs`, `e`, `k`, `N_A`,
  ...
  `662607015e-42` (not a `Ratio`). CODATA 2018 Planck constant in eV/Hz `h_eVHz` is an exact `Ratio`
  `44173801/10681177560000000000000` eV Hz⁻¹ from JPCRD table XXXI UNIVERSAL (not a terminating
  `SciExact`: 2, 3, 5, 19, 389, and 12043 remain in the denominator; `ħ` is not stored).
  CODATA 2018 kilogram-joule relationship `kg_J` is an exact `Ratio`
  `89875517873681764` J from JPCRD table XXXV (not SI metre-per-second `c`; not second
  radiation `c2`; not a FormalClaim of `c*c` from live lookups).
  CODATA 2018 inverse meter-joule relationship `m_J` is SI-exact `SciExact`
  `19864458571489287e-41` J from JPCRD table XXXV (not a `Ratio`: `i128` denominator overflow;
  not `h`; not `c`; not `c1L`; not a FormalClaim of `h*c` from live lookups).
  CODATA 2018 inverse meter-electron volt relationship `m_eV` is an exact `Ratio`
  `6621486190496429/5340588780000000000000` eV from JPCRD table XXXV (not a terminating
  `SciExact`: 2, 3, 5, 19, 389, and 12043 remain in the denominator; not `h`; not `c`; not `eV`;
  not `h_eVHz`; not a FormalClaim of `h c / e` from live lookups).
  ...
  table. CODATA 2018 `hcRinf_eV` is a one-sigma `Interval` `13.605693122994(26)` eV
  from the same table (not an SI defining `Ratio`; not `hcRinf`; not `Eh_eV`; not a FormalClaim of `hcRinf/e`;
  quantum of circulation still cites `π ℏ / m_e`). CODATA 2018
  Rydberg `R∞` is a
  ...
  `4.3597447222071(85)×10^{-18}` J from the same table. CODATA 2018 `Eh_eV` is a
  one-sigma `Interval` `27.211386245988(53)` eV from the same table (not an SI defining
  `Ratio`; not `Eh`; not a FormalClaim of `Eh/e`).
  ...
  C kg⁻¹ from the same section. CODATA 2018 electron mass in u `m_e_u` is a
  one-sigma `Interval` `5.48579909065(16)×10^{-4}` u from the same section (not an SI defining
  `Ratio`; not `M_e`; not relative atomic mass; not kg `m_e`). CODATA 2018 electron mass energy equivalent `m_e_c2` is a
  one-sigma `Interval` `8.1871057769(25)×10^{-14}` J from the same section (not an SI defining
  `Ratio`; not `m_e_u`; not kg `m_e`; not `m_mu_c2`; not SI-exact `eV`). CODATA 2018 electron mass energy equivalent in MeV `m_e_c2_MeV` is a
  one-sigma `Interval` `0.51099895000(15)` MeV from the same section (not an SI defining
  `Ratio`; not `m_e_c2`; not `m_mu_c2_MeV`; not SI-exact `eV`). CODATA 2018 electron molar mass
  ...
  CODATA 2018 Boltzmann constant in eV/K `k_eV` is an exact `Ratio`
  `1380649/16021766340` eV K⁻¹ from the same section (not a terminating
  `SciExact`: 3, 19, 389, and 12043 remain in the denominator).
  CODATA 2018 Boltzmann constant in Hz/K `k_Hz` is an exact `Ratio`
  `2761298000000000000/132521403` Hz K⁻¹ from the same section (not a terminating
  `SciExact`: 3, 7, and 6310543 remain in the denominator).
  CODATA 2018 Boltzmann constant in inverse meter per kelvin `k_m` is an exact `Ratio`
  `18913000000000000/272115870842319` m⁻¹ K⁻¹ from the same section (not a terminating
  `SciExact`: 3, 7, 293339, and 6310543 remain in the denominator; Faraday constant is NAe).
  ...
  `Ratio`; not `muN`; not `muB_eV`; not a FormalClaim of `muN/e`).
  CODATA 2018 nuclear magneton in inverse meter per tesla `muN_m` is a one-sigma `Interval`
  `2.54262341353(78)×10^{-2}` m⁻¹ T⁻¹ from the same section (not an SI defining
  `Ratio`; not `muN`; not `muB_m`; not a FormalClaim of `muN/hc`).
  CODATA 2018 nuclear magneton in K/T `muN_K` is a one-sigma `Interval`
  `3.6582677756(11)×10^{-4}` K T⁻¹ from the same section (not an SI defining
  `Ratio`; not `muN`; not `muB_K`; not a FormalClaim of `muN/k`).
  CODATA 2018 nuclear magneton in MHz/T `muN_MHz` is a one-sigma `Interval`
  `7.6225932291(23)` MHz T⁻¹ from the same section (not an SI defining
  `Ratio`; not `muN`; not `muB_Hz`; not a FormalClaim of `muN/h`).
  CODATA 2018 proton gyromagnetic ratio `gamma_p` is a one-sigma `Interval`
  `2.6752218744(11)×10^{8}` s⁻¹ T⁻¹ from JPCRD table XXXI Proton, p (not an SI defining
  `Ratio`; not `gp`; not `mu_p`; not `muN`; not `muB_Hz`; not `muN_MHz`; not a FormalClaim of
  `2 mu_p / hbar`).
  CODATA 2018 proton gyromagnetic ratio in MHz/T `gamma_p_MHz` is a one-sigma `Interval`
  `42.577478518(18)` MHz T⁻¹ from the same section (not an SI defining
  `Ratio`; not `gamma_p`; not `muN_MHz`; not `muB_Hz`; not a FormalClaim of `gamma_p / 2π`).
  CODATA 2018 shielded proton gyromagnetic ratio `gamma0p` is a one-sigma `Interval`
  `2.675153151(29)×10^{8}` s⁻¹ T⁻¹ from the same section (not an SI defining
  `Ratio`; not `gamma_p`; not `mu0p`; not `g0p`; not a FormalClaim of `2 mu0p / hbar`).
  CODATA 2018 shielded proton gyromagnetic ratio in MHz/T `gamma0p_MHz` is a one-sigma `Interval`
  `42.57638474(46)` MHz T⁻¹ from the same section (not an SI defining
  `Ratio`; not `gamma0p`; not `gamma_p_MHz`; not `muN_MHz`; not a FormalClaim of `gamma0p / 2π`).
  CODATA 2018 neutron gyromagnetic ratio `gamma_n` is a one-sigma `Interval`
  `1.83247171(43)×10^{8}` s⁻¹ T⁻¹ from JPCRD table XXXI Neutron, n (not an SI defining
  `Ratio`; not `gn`; not `gamma_p`; not `gamma0p`; not `mu_n`; not a FormalClaim of `2 mu_n / hbar`).
  CODATA 2018 neutron gyromagnetic ratio in MHz/T `gamma_n_MHz` is a one-sigma `Interval`
  `29.1646931(69)` MHz T⁻¹ from the same section (not an SI defining
  `Ratio`; not `gamma_n`; not `gamma_p_MHz`; not `gamma0p_MHz`; not `muN_MHz`; not a FormalClaim of `gamma_n / 2π`).
  CODATA 2018 electron gyromagnetic ratio `gamma_e` is a one-sigma `Interval`
  `1.76085963023(53)×10^{11}` s⁻¹ T⁻¹ from JPCRD table XXXI Electron, e- (not an SI defining
  `Ratio`; not `ge`; not `mu_e`; not `gamma_p`; not `gamma_n`; not a FormalClaim of `2 mu_e / hbar`).
  CODATA 2018 electron gyromagnetic ratio in MHz/T `gamma_e_MHz` is a one-sigma `Interval`
  `28024.9514242(85)` MHz T⁻¹ from the same section (not an SI defining
  `Ratio`; not `gamma_e`; not `gamma_p_MHz`; not `gamma_n_MHz`; not `gamma0p_MHz`; not a FormalClaim of `gamma_e / 2π`).
  CODATA 2018 shielded helion gyromagnetic ratio `gamma0h` is a one-sigma `Interval`
  `2.037894569(24)×10^{8}` s⁻¹ T⁻¹ from JPCRD table XXXI Helion, h (not an SI defining
  `Ratio`; not `gamma0p`; not `gamma_e`; not `mu0h`; not `gh`; not a FormalClaim of `2 mu0h / hbar`).
  CODATA 2018 shielded helion gyromagnetic ratio in MHz/T `gamma0h_MHz` is a one-sigma `Interval`
  `32.43409942(38)` MHz T⁻¹ from the same section (not an SI defining
  `Ratio`; not `gamma0h`; not `gamma0p_MHz`; not `gamma_e_MHz`; not `gamma_n_MHz`; not a FormalClaim of `gamma0h / 2π`;
  glossary `g0p` is still skipped).
  CODATA 2018 electron mass `m_e` is a one-sigma `SciInterval` `9.1093837015(28)×10^{-31}` kg from JPCRD table XXXI Electron, e-
  (not an SI defining `Ratio`; Ratio scale `10^{41}` overflows `i128`; not `m_e_u`; not `m_e_c2`; not `M_e`; not a FormalClaim of `m_e_u × m_u`).
  CODATA 2018 natural unit of momentum `nu_p` is a one-sigma `Interval` `2.73092453075(82)×10^{-22}` kg m s^{-1} from JPCRD table XXXIV Natural units
  (not an SI defining `Ratio`; not the kg hull; not the joule energy equivalent; not the MeV/c companion; not a FormalClaim of the product from live lookups).
  CODATA 2018 atomic unit of force `au_F` is a one-sigma `Interval` `8.2387234983(12)×10^{-8}` N from JPCRD table XXXIV Atomic units
  (not an SI defining `Ratio`; not the energy hull; not the length hull; not a FormalClaim of the quotient from live lookups).
  CODATA 2018 atomic unit of velocity `au_v` is a one-sigma `Interval` `2.18769126364(33)×10^{6}` m s^{-1} from JPCRD table XXXIV Atomic units
  (not an SI defining `Ratio`; not SI metre-per-second; not a FormalClaim of the product from live lookups).
  CODATA 2018 atomic unit of permittivity `au_eps` is a one-sigma `Interval` `1.11265005545(17)×10^{-10}` F m^{-1} from JPCRD table XXXIV Atomic units
  (not an SI defining `Ratio`; not vacuum permittivity; not a FormalClaim of the printed quotient or 4pi epsilon0 from live lookups).
  CODATA 2018 atomic unit of momentum `au_p` is a one-sigma `Interval` `1.99285191410(30)×10^{-24}` kg m s^{-1} from JPCRD table XXXIV Atomic units
  (not an SI defining `Ratio`; not natural-unit momentum; not a FormalClaim of the printed quotient from live lookups).
  CODATA 2018 natural unit of time `nu_t` is a one-sigma `Interval` `1.28808866819(39)×10^{-21}` s from JPCRD table XXXIV Natural units
  (not an SI defining `Ratio`; not Planck time; not atomic-unit time; not a FormalClaim of the printed quotient from live lookups). IAU 2012 `au` is an exact
  `Ratio` `149597870700` m (BIPM table 8). BIPM table 8 `barn` is an exact `Ratio` `1/10^{28}` square metres from the same table (not Thomson, not `Astar`). BIPM table 8 `angstrom` is an exact `Ratio` `1/10^{10}` m from the same table (not Angstrom star `Astar`). BIPM table 8 `gal` is an exact `Ratio` `1/100` m s^{-2} from the same table (not the CGPM 1901 standard gravity listing). BIPM table 8 `nautical_mile` is an exact `Ratio` `1852` m from the same table (not the astronomical-unit listing). BIPM table 8 `hectare` is an exact `Ratio` `10000` square metres from the same table (not the nuclear-physics area listing). BIPM table 8 `knot` is an exact `Ratio` `463/900` m s^{-1} from the same table (not the atomic-unit-of-velocity listing). BIPM table 8 `are` is an exact `Ratio` `100` square metres from the same table (not the 10^4 land-area listing). The electronvolt is an exact
  ...
  measured solar luminosity. IAU 2015 `S_☉^N` is an exact `Ratio` `1361` W m^{-2} from the same table: a conversion ruler, not a measured solar irradiance. IAU 2015 `T_☉^N` is an exact `Ratio` `5772` K from the same table: a conversion ruler, not a measured solar effective temperature. IAU 2015 `R_Ee^N` is an exact `Ratio` `6378100` m from the same table: a conversion ruler, not a measured terrestrial equatorial radius. IAU 2015 `R_Ep^N` is an exact `Ratio` `6356800` m from the same table: a conversion ruler, not a measured terrestrial polar radius. IAU 2015 `R_Je^N` is an exact `Ratio` `71492000` m from the same table: a conversion ruler, not a measured Jovian equatorial radius. IAU 2015 `R_Jp^N` is an exact `Ratio` `66854000` m from the same table: a conversion ruler, not a measured Jovian polar radius. IAU 2015 `(GM)_E^N` is an exact `Ratio` `3.986004×10^14` m³ s⁻² from the same table: a conversion ruler, not a measured terrestrial mass. IAU 2015 `(GM)_J^N` is an exact `Ratio` `1.2668653×10^17` m³ s⁻² from the same table: a conversion ruler, not a measured Jovian mass. IAU 2015 bolometric-magnitude zero is an exact `Ratio` `3.0128×10^28` W from Resolution B2 equation 1: a conversion ruler, not a measured luminosity. `physis constant [name]`
  ...
  `c`, `au`, `p0`, `atm`, `GM_sun`, `R_sun`, `L_sun`, `S_sun`, `T_sun`, `R_earth`, `R_earth_p`, `R_jup`, `R_jup_p`, `GM_earth`, `GM_jup`, and `L_0` via integer `to_f64`; `e`/`k`/`eV`/`NAh`/`NAk`/`NAe`/`Vm` via IEEE rounding of the SI
  decimal (`SciExact::to_f64`, not reduced `Ratio::to_f64`); `n0`/`Vm_atm`/`n0_atm`/`c2`/`KJ`/`RK`/`k_eV`/`k_Hz`/`k_m`/`h_eVHz`/`kg_J`/`m_eV`/`J_eV`/`J_K`/`eV_Hz`/`eV_K`/`Hz_K`/`Hz_m` via IEEE rounding of the exact `Ratio`; `h`/`c1L`/`m_J` via
  `SciExact::to_f64`; `G`, `mu0`, `epsilon0`, `Z0`, `alpha`, `inv_alpha`, `cRinf`, `hcRinf`, `hcRinf_eV`, `Rinf`, `a0`, `Eh`, `Eh_eV`, `me_mmu`, `me_mp`, `me_mn`, `me_md`, `me_mt`, `me_mh`, `me_malpha`, `e_me`, `m_e`, `nu_p`, `au_F`, `au_v`, `au_eps`, `au_p`, `nu_t`, `m_e_u`, `m_e_c2`, `m_e_c2_MeV`, `M_e`, `lambdabar_C`, `lambda_C`, `re`, `mu_e`, `mu_e_muB`, `mu_e_muN`, `ae`, `ge`, `mu_e_mmu`, `mu_e_mup`, `mu_e_mu0p`, `mu_e_mun`, `mu_e_mud`, `mu_e_mu0h`, `m_mu`, `m_mu_u`, `m_mu_c2`, `m_mu_c2_MeV`, `mmu_me`, `mmu_mp`, `mmu_mn`, `M_mu`, `lambda_C_mu`, `mu_mu`, `mu_mu_muB`, `mu_mu_muN`, `amu`, `gmu`, `mu_mu_mup`, `m_p`, `m_p_u`, `m_p_c2`, `m_p_c2_MeV`, `mp_me`, `mp_mmu`, `mp_mn`, `e_mp`, `M_p`, `lambda_C_p`, `rp`, `mu_p`, `mu_p_muB`, `mu_p_muN`, `gp`, `mu_p_mun`, `mu0p`, `mu0p_muB`, `mu0p_muN`, `sigma0p`, `m_n`, `m_n_u`, `m_n_c2`, `m_n_c2_MeV`, `mn_me`, `mn_mmu`, `mn_mp`, `mn_minus_mp`, `mn_minus_mp_u`, `mn_minus_mp_c2`, `mn_minus_mp_c2_MeV`, `M_n`, `lambda_C_n`, `mu_n`, `mu_n_muB`, `mu_n_muN`, `gn`, `mu_n_mue`, `mu_n_mup`, `mu_n_mu0p`, `m_d`, `m_d_u`, `m_d_c2`, `m_d_c2_MeV`, `md_me`, `md_mp`, `M_d`, `rd`, `mu_d`, `mu_d_muB`, `mu_d_muN`, `gd`, `mu_d_mue`, `mu_d_mup`, `mu_d_mun`, `m_t`, `m_t_u`, `m_t_c2`, `m_t_c2_MeV`, `mt_me`, `mt_mp`, `M_t`, `mu_t`, `mu_t_muB`, `mu_t_muN`, `gt`, `m_h`, `m_h_u`, `m_h_c2`, `m_h_c2_MeV`, `mh_me`, `mh_mp`, `M_h`, `mu_h`, `mu_h_muB`, `mu_h_muN`, `gh`, `mu0h`, `mu0h_muB`, `mu0h_muN`, `mu0h_mup`, `mu0h_mu0p`, `m_alpha`, `m_alpha_u`, `m_alpha_c2`, `m_alpha_c2_MeV`, `malpha_me`, `malpha_mp`, `M_alpha`, `m_u`, `m_u_c2`, `m_u_c2_MeV`, `M_u`, `M_12C`, `S0_R`, `S0_R_atm`, `muB`, `muB_eV`, `muB_Hz`, `muB_m`, `muB_K`, `muN`, `muN_eV`, `muN_m`, `muN_K`, `muN_MHz`, `gamma_p`, `gamma_p_MHz`, `gamma0p`, `gamma0p_MHz`, `gamma_n`, `gamma_n_MHz`, `gamma_e`, `gamma_e_MHz`, `gamma0h`, `gamma0h_MHz`, and `Hz_Eh` Qty values are the CODATA centres
  inside the hulls.
...
- Mathlib-scale Physlib; six catalog identities are kernel-checked
  (triangle `d²`, 3-simplex coboundary, interval, Einstein composition, mass shell, cross-product Jacobi). The mass-shell
  polynomial is the interval identity on 4-momentum, not a distinct
  algebraic idea; Jacobi of the cross product is. That is not Mathlib.
...
- Trust tiers do not gate observation or standalone encoding-review.
  ...
  `CertifiedNumeric` enclosure or a GQW / one-loop α_3 / one-loop α_em⁻¹ input-interval overlay; that is
  `numerical-verifier` (`physis enclose`, a content-addressed
  NumericCertificate; Ratio parse of the four P3N cells; independent
  `Interval` parse of `gut.weinberg-angle-mz-interval`,
  `gut.coupling-unification-interval`, and `gut.inverse-alpha-em-mz-interval` is not
  `CertifiedNumeric` and is not P3N; not a kernel receipt, not Canonical,
  not P4). A reviewer cannot independently
...
| C. Interval-certified numeric | Independent `Interval::parse_display` of the GQW overlay on `gut.weinberg-angle-mz-interval`, the one-loop `α_3` overlay on `gut.coupling-unification-interval`, and the one-loop `α_em⁻¹` overlay on `gut.inverse-alpha-em-mz-interval` (not P3N, not `CertifiedNumeric`). GUT-scale `3/8` remains the `Ratio` / P3N identity, disjoint from the PDG `0.23122` hull |
...
| D. Empirical comparison | `EmpiricalReceipt` against versioned PDG datasets **and** Super-K `p→e+π0`. Compatible is prediction ⊆ data; overlap without containment is inconclusive (`InsufficientPrecision`), not compatible. PDG `sin²θ_W(M_Z)`, `α_s(M_Z)`, and `α_em⁻¹(M_Z)` are Gaussians (`μ`, `σ` as Ratio); Super-K is a lower-limit hull, not a Gaussian, not P3N |
