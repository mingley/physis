...
Level-3 trust
  ...
  L3 CODATA mu_e           ✓ physis-constants versions CODATA 2018 electron magnetic moment as a one-sigma Interval -9.2847647043(28)e-24 J T^{-1} (JPCRD table XXXI Electron, e-); not the Bohr-magneton ratio; Thomson skipped (pi); not P3N; Qty is the recommended signed centre inside the hull; theories still use physis_model f64 Qty
