...
Level-3 trust
  ...
  L3 CODATA ae             ✓ physis-constants versions CODATA 2018 electron magnetic-moment anomaly as a one-sigma Interval 1.15965218128(18)e-3 (JPCRD table XXXI Electron, e-); not the g-factor; not the signed Bohr-magneton ratio; Thomson skipped (pi); not P3N; Qty is the recommended centre inside the hull; theories still use physis_model f64 Qty
  L3 CODATA ge             ✓ physis-constants versions CODATA 2018 electron g-factor as a one-sigma Interval -2.00231930436256(35) (JPCRD table XXXI Electron, e-); not the anomaly; not the signed Bohr-magneton ratio; Thomson skipped (pi); not P3N; Qty is the recommended signed centre inside the hull; theories still use physis_model f64 Qty
  L3 CODATA mu_e_mmu       ✓ physis-constants versions CODATA 2018 electron-muon magnetic-moment ratio as a one-sigma Interval 206.7669883(46) (JPCRD table XXXI Electron, e-); not the electron-muon mass ratio; Thomson skipped (pi); not P3N; Qty is the recommended centre inside the hull; theories still use physis_model f64 Qty
  L3 CODATA mu_e_mup       ✓ physis-constants versions CODATA 2018 electron-proton magnetic-moment ratio as a one-sigma Interval -658.21068789(20) (JPCRD table XXXI Electron, e-); not the electron-proton mass ratio; not the shielded-proton moment ratio; Thomson skipped (pi); not P3N; Qty is the recommended signed centre inside the hull; theories still use physis_model f64 Qty
  L3 CODATA mu_e_mu0p      ✓ physis-constants versions CODATA 2018 electron to shielded-proton magnetic-moment ratio as a one-sigma Interval -658.2275971(72) (JPCRD table XXXI Electron, e-); not the free-proton moment ratio; not vacuum permeability; Thomson skipped (pi); not P3N; Qty is the recommended signed centre inside the hull; theories still use physis_model f64 Qty
  L3 CODATA mu_e_mun       ✓ physis-constants versions CODATA 2018 electron-neutron magnetic-moment ratio as a one-sigma Interval 960.92050(23) (JPCRD table XXXI Electron, e-); not the electron-neutron mass ratio; Thomson skipped (pi); not P3N; Qty is the recommended centre inside the hull; theories still use physis_model f64 Qty
