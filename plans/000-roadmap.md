...
Level-3 trust
  ...
  L3-M7 physis-ir          ✓ line-oriented theory packages plus constrained mutations; combinational NAND, Klein-Gordon stencil, Wilson U(1)/SU(2)/SU(3) plaquettes, ohm-circuit lumped branches, bell-test singlet ket, and newtonian-gravity inverse-square Binet rhs are live packages
  ...
  L3 hypothesize           ✓ chosen/fitted knob probes and IR package forks; measured knobs frozen; mutants not installed; explorer can observe; does not mint; combinational add-feedback, klein-gordon add-next-nearest, wilson add-rectangle (U(1)/SU(2)/SU(3)), ohm-circuit add-tline, bell-test add-product, and newtonian-gravity add-schwarzschild are package mutations, not knobs
