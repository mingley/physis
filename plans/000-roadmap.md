...
Level-3 trust
  ...
  L3-M7 physis-ir          ✓ line-oriented theory packages plus constrained mutations; combinational NAND, Klein-Gordon stencil, Wilson U(1)/SU(2)/SU(3) plaquettes, ohm-circuit lumped branches, and bell-test singlet ket are live packages
  ...
  L3 hypothesize           ✓ chosen/fitted knob probes and IR package forks; measured knobs frozen; mutants not installed; explorer can observe; does not mint; combinational add-feedback, klein-gordon add-next-nearest, wilson add-rectangle (U(1)/SU(2)/SU(3)), ohm-circuit add-tline, and bell-test add-product are package mutations, not knobs
  ...
  L3 encoding round-trip   ✓ physis encode independently parses, round-trips, and reconstructs live IR packages (combinational NAND, Klein-Gordon stencil, Wilson U(1)/SU(2)/SU(3) plaquettes, ohm-circuit lumped branches, bell-test singlet ket); encoding-auditor unique op; restore rebuilds; not P3S, not Canonical, not P4
