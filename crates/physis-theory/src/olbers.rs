...
impl Theory for OlbersSky {
    ...
    fn summary(&self) -> &'static str {
        "A Euclidean universe uniformly filled with starlight. Inverse-square \
         ...
         ρ_L c/H. Those are independent knob turns."
    }
...
pub fn olbers() -> ExperimentReport {
    report_from_rows(
        ...
        vec![
            ...
            "`set olbers-static finite_age true` is the finite-age resolution; `set olbers-static expanding true` is Hubble dimming. They are independent.".into(),
