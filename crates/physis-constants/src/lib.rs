...
//! hull, not an SI defining Ratio, and not the Bohr-magneton ratio. The Thomson
...
/// Ratio, not the Bohr-magneton ratio, not the Thomson cross section,
/// and not P3N. Theories still use `physis_model` `f64` Qty.
